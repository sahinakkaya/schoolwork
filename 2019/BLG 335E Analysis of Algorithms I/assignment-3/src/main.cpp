...
int main() {
  ...
  // int westWarehousePackageSizes[] = {1,1,1,5,6};
  // int westWarehousePackageOrdinals[] = {4,5,7,1,2};
  auto ans = hw3(eastWarehousePackageCount, eastWarehousePackageSizes,
                 eastWarehousePackageOrdinals, westWarehousePackageCount,
                 westWarehousePackageSizes, westWarehousePackageOrdinals);
  cout << ans.packageCount << " " << ans.redNodeCount << " "
       << ans.blackNodeCount << endl;
}